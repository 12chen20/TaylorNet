...
if __name__ == '__main__':
    ...
    parser.add_argument('--Taylor_lr', type=float, default=0.1, help='learning rate for TaylorNet propagation layer.')
    ...
    parser.add_argument('--dataset', type=str,
                        choices=['Cora', 'Citeseer', 'Pubmed', 'Computers', 'Photo','Texas', 'Cornell','film'],
                        default='Cora')
    ...
    for RP in tqdm(range(args.runs)):
        args.seed = SEEDS[RP]
        test_acc, best_val_acc, tmp_test_loss, train_loss, theta_0, time_run = RunExp(args, dataset, data, Net,
                                                                                      percls_trn, val_lb)
